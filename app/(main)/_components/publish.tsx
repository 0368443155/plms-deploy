...
export const Publish = ({ initialData }: PublishProps) => {
  ...
  const onPublish = () => {
    ...
    toast.promise(promise, {
      ...
      success: "Đã xuất bản ghi chú!",
      error: "Không thể xuất bản ghi chú.",
    });
  };
  ...
  const onUnpublish = () => {
    ...
    toast.promise(promise, {
      ...
      success: "Đã hủy xuất bản ghi chú!",
      error: "Không thể hủy xuất bản ghi chú.",
    });
  };
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-x-2">
              ...
              <p className="text-xs font-medium text-sky-500">
                Ghi chú này đang được hiển thị trên web.
              </p>
            </div>
